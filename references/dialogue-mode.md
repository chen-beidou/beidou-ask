# Dialogue and confrontation mode

Use when dialogue, gaze, silence, and micro-actions carry the scene.

## Tension unit

```text
pressure → containment → leak/deflection → listener interpretation
...
State who stands/sits, who controls the exit or prop, who is higher/lower, who faces the door, and who first changes distance. A power shift should become visible through position, gaze, or prop ownership.

## Micro-actions

Each micro-action needs a cause and result:

- fingers tighten → paper creases
- hand reaches → stops before contact
- cigarette pauses → ash falls untouched
- gaze meets → one person moves first
- body rises → decides not to leave → sits differently

Avoid generic sequences such as “looks emotional, pauses, sighs” without a relationship consequence.
